...
| [0030](0030-coordonnees-et-creation-par-les-pc.md) | Coordonnées tapées (décimal, virgule, DMS, paire collée) dans chaque formulaire de création et de modification ; hôpital de campagne déployé avec cascade + carte + coordonnées ; créer unité, hôpital, hôpital de campagne, morgue, morgue mobile : Super Administrateur, chefs, Rens, OPS, LOG, Anim (profil direx) — créer n'est pas retirer |
