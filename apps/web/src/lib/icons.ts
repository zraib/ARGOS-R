...
export const NAV_ICONS = {
  ...
  opsnet: "M12 3a2.5 2.5 0 100 5 2.5 2.5 0 000-5z M5 16a2.5 2.5 0 100 5 2.5 2.5 0 000-5z M19 16a2.5 2.5 0 100 5 2.5 2.5 0 000-5z M10.4 7.4L6.6 14.2 M13.6 7.4l3.8 6.8 M7.5 18.5h9",
  ...
  // Service morgue : un bâtiment bas surmonté d'une croix discrète.
  morgue: "M3 21h18 M5 21V11h14v10 M12 3v6 M9 6h6 M9 15h2v6h-2z M13 15h2v6h-2z",
...
export const UI_ICONS = {
  ...
  /** Avion vu de dessus — bouton du suivi aérien sur la carte. */
  ...
  /** Fiche détaillée (chaîne de garde, historique). */
