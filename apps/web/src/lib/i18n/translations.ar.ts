...
export const AR_DICT: Dict = {
    ...
    nav_chemlib: "المواد الخطرة", cl_title: "مكتبة المواد الخطرة", cl_search: "الاسم أو المرادف أو رقم الأمم المتحدة أو CAS…", cl_count: "مادة", cl_none: "لا توجد مادة مطابقة", cl_provenance: "مصدر البيانات", cl_sheet_unverified: "البطاقة غير مُطابَقة مع CAMEO Chemicals — يجب التحقق قبل الاستعمال العملياتي", cl_erg_missing: "مسافات ERG غير مسجَّلة — نموذج ERG غير متاح، ويبقى ATP-45 صالحًا", cl_erg_unverified: "مسافات يجب تأكيدها من الجدول 1 لدليل ERG 2024", cl_erg_verified: "مسافات مأخوذة من دليل ERG 2024", cl_appearance: "المظهر والرائحة", cl_behaviour: "السلوك عند التسرب", cl_health: "الآثار الصحية", cl_fire: "الحريق", cl_reactivity: "التفاعلية", cl_ppe: "الحماية", cl_vapor: "كثافة البخار", cl_boiling: "درجة الغليان", cl_heavier: "أثقل من الهواء — يتجمع في المنخفضات", cl_lighter: "أخف من الهواء — يرتفع", cl_un: "رقم الأمم المتحدة", cl_cas: "رقم CAS", cl_guide: "دليل ERG",
    cl_count_one: "مادة",
    ...
    cl_prov_sheets: "بطاقة عملياتية —", cl_prov_sheets_ok: "قُوبلت بقاعدة CAMEO Chemicals (NOAA).",
    cl_prov_erg: "مجموعة مسافات —", cl_prov_erg_ok: "مأخوذة من الجدول 1 لدليل ERG 2024.",
    cl_prov_origin: "مجموعة مُحمَّلة:",
    cl_prov_origins: "مجموعات محمَّلة — انظر المصدر وسند الحيازة",
