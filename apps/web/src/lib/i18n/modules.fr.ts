...
export const FR_MODULES: ModulesDict = {
  ...
  morgue: {
    ...
    edit_site: "Modifier le site", edit_site_title: "Modifier le site mortuaire", site_updated: "Site mortuaire mis à jour.",
  ...
  features: { dashboard: "Tableau de bord général", dash_incident: "Tableau de bord Incident", dash_hospital: "Tableau de bord Hôpital", dash_shelter: "Tableau de bord Abri", dash_morgue: "Tableau de bord Morgue", dash_unit: "Tableau de bord Unité", map: "Carte", incidents: "Incidents", subincidents: "Sous-incidents (ajouter, modifier, supprimer)", victims: "Bilan des victimes", actions_log: "Actions entreprises (journal de conduite)", hospinet: "Hospinet", shelters: "Abris", morgue: "Morgue", units: "Unités", equipment: "Gestion des équipements", teams: "Unités / Équipes", comms: "Centre de communication", reports: "Rapports d'incidents", analytics: "Analytique", assistant: "Assistant IA", users: "Gestion des utilisateurs", settings: "Paramètres", assign: "Affectation des unités", deploy: "Déploiement terrain", resources: "Ressources (personnes, équipes, véhicules, logistique)", weather: "Météo", plume: "Simulation NRBC (panache)", dispatch: "Répartiteur", triage: "Triage de masse", ics: "Formulaires ICS", damage: "Évaluation des dommages", orsec: "Tableau ORSEC", plans: "Plans", personnel: "Personnel", workorders: "Bons de travail", seismic: "Sismologie & météo", audit: "Journal d'audit", aviation: "Suivi aérien", nrbc: "NRBC", missions: "Missions (boucles opérationnelles)", tracking: "Traceurs GPS", comms_admin: "Administration des canaux", map_edit: "Édition de la carte (postes d'opération)" },
  users: {
    title: "Gestion des utilisateurs", subtitle: "Création, rôles et cycle de vie des comptes",
    tab_users: "Utilisateurs", tab_roles: "Rôles & fonctionnalités", assignment_optional: "optionnel — l'entité peut être affectée plus tard ; sans elle, le compte ne voit rien", tab_classique: "Utilisateurs classique", tab_direx: "Utilisateurs Direx", profile_of_account: "Profil du compte", modules_title: "Modules du menu", modules_hint: "Ce que le rôle voit dans le menu.", features_title: "Fonctionnalités de l'API (43)", features_hint: "Chaque fonctionnalité de la matrice s'ouvre ou se coupe pour ce rôle : coupée, toutes ses actions lui sont refusées (403), sans toucher à la matrice. Le cœur (comptes, paramètres, journal d'audit) reste verrouillé.", feature_locked: "Fonctionnalité du cœur : verrouillée",
...
firstname: "Prénom", firstname_ph: "ex. Ahmed", phone: "Numéro de téléphone", phone_ph: "+212 6 00 00 00 00", grade_none: "— Sélectionner un grade —", created_title: "Utilisateur créé", created_hint: "Transmettez ces identifiants à l'utilisateur par un canal sûr. Le mot de passe provisoire doit être changé à la première connexion.", created_close: "Terminé", col_phone: "Téléphone", identity: "Identité",     name: "Nom", name_ph: "ex. Tazi", grade: "Grade", grade_ph: "ex. Capitaine",
  ...
  wizard: {
    ...
    involved_hint: "Touchées par l'incident sans en être victimes : évacuées, relogées, sinistrées, témoins — ni blessées, ni disparues, ni décédées.",
    involved_one: "Impliqué",
    infected: "Infectés",
