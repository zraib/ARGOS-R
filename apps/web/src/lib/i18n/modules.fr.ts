...
export const FR_MODULES: ModulesDict = {
  ...
  morgue: {
    ...
    detail: "Chaîne de garde", custody_none: "Dossier antérieur au registre de garde — admission le", by: "par", pending_badge: "Réception à confirmer", open_site: "Gérer mon site",
