...
export const FR_MODULES: ModulesDict = {
  ...
  morgue: {
    ...
    sites: "Sites", sites_sub: "fixes + mobiles", site_fixed: "Site fixe", site_mobile: "Morgue mobile", places_free: "Emplacements libres", present: "Corps présents", pending: "Réceptions en attente", pending_short: "à réceptionner", unidentified: "Non identifiés",
