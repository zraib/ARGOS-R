...
export const EN_DICT: Dict = {
    ...
    nav_chemlib: "Hazardous substances", cl_title: "Hazardous substances library", cl_search: "Name, synonym, UN or CAS number…", cl_count: "substances", cl_none: "No matching substance", cl_provenance: "Data provenance", cl_sheet_unverified: "Datasheet not checked against CAMEO Chemicals — verify before operational use", cl_erg_missing: "ERG distances not recorded — ERG template unavailable, ATP-45 still usable", cl_erg_unverified: "Distances to be confirmed against ERG 2024 Table 1", cl_erg_verified: "Distances taken from ERG 2024", cl_appearance: "Appearance and odour", cl_behaviour: "Release behaviour", cl_health: "Health effects", cl_fire: "Fire", cl_reactivity: "Reactivity", cl_ppe: "Protection", cl_vapor: "Vapour density", cl_boiling: "Boiling point", cl_heavier: "heavier than air — collects in low points", cl_lighter: "lighter than air — rises", cl_un: "UN no.", cl_cas: "CAS no.", cl_guide: "ERG guide",
    ...
    cl_prov_sheets: "operational sheets —", cl_prov_sheets_ok: "checked against CAMEO Chemicals (NOAA).",
    cl_prov_erg: "distance sets —", cl_prov_erg_ok: "read from ERG 2024 table 1.",
    cl_prov_origin: "Imported set:",
    cl_prov_origins: "imported sets — see origin and licence held",
