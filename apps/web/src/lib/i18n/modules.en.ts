...
export const EN_MODULES: ModulesDict = {
  ...
  morgue: {
    ...
    sites: "Sites", sites_sub: "fixed + mobile", site_fixed: "Fixed site", site_mobile: "Mobile morgue", places_free: "Free places", present: "Bodies present", pending: "Receipts pending", pending_short: "to receive", unidentified: "Unidentified",
