...
export const FR_DICT: Dict = {
    ...
    nav_chemlib: "Substances dangereuses", cl_title: "Bibliothèque des substances dangereuses", cl_search: "Nom, synonyme, n° ONU ou CAS…", cl_count: "substances", cl_none: "Aucune substance ne correspond", cl_provenance: "Provenance des données", cl_sheet_unverified: "Fiche non confrontée à CAMEO Chemicals — à vérifier avant emploi opérationnel", cl_erg_missing: "Distances ERG non renseignées — gabarit ERG indisponible, ATP-45 reste utilisable", cl_erg_unverified: "Distances à confirmer sur la table 1 de l'ERG 2024", cl_erg_verified: "Distances relevées sur l'ERG 2024", cl_appearance: "Aspect et odeur", cl_behaviour: "Comportement au rejet", cl_health: "Effets sur la santé", cl_fire: "Incendie", cl_reactivity: "Réactivité", cl_ppe: "Protection", cl_vapor: "Densité de vapeur", cl_boiling: "Ébullition", cl_heavier: "plus lourd que l'air — s'accumule dans les points bas", cl_lighter: "plus léger que l'air — s'élève", cl_un: "N° ONU", cl_cas: "N° CAS", cl_guide: "Guide ERG",
    ...
    cl_prov_sheets: "fiches opérationnelles —", cl_prov_sheets_ok: "confrontées à CAMEO Chemicals (NOAA).",
    cl_prov_erg: "jeux de distances —", cl_prov_erg_ok: "relevés sur la table 1 de l'ERG 2024.",
    cl_prov_origin: "Jeu versé :",
    cl_prov_origins: "jeux versés — voir l'origine et le titre de détention",
