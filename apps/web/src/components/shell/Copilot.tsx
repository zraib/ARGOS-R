...
function Fab({ unread }: { unread: number }) {
  ...
  return (
    ...
    >
      ...
      <span className="relative flex h-16 w-16 items-center justify-center rounded-full bg-or-500 text-rdia-900 shadow-2xl shadow-or-500/40 ring-4 ring-white transition-transform duration-200 group-hover:scale-110 active:scale-95 dark:ring-rdia-800">
