    ...
    <>
      ...
      {!copilotOpen && (
        ...
        >
          ...
          <span className="relative flex h-[72px] w-[72px] items-center justify-center rounded-full bg-or-500 text-rdia-900 shadow-2xl shadow-or-500/40 ring-4 ring-white dark:ring-rdia-800 transition-transform duration-200 group-hover:scale-110 active:scale-95">
            <Icon path={UI_ICONS.copilot} size={38} strokeWidth={2} />
            {unreadBadge > 0 && (
