...
describe("Mode de l'application — réglage de station", () => {
  ...
  it("en mode classique, un compte Direx n'entre pas et son jeton ne sert pas ; les rôles Direx ne s'attribuent pas", async () => {
    ...
    // La matrice servie ne montre que le profil en service.
  ...
  it("en mode Direx : les comptes Direx entrent, les comptes classiques sont refusés et leurs sessions tombent ; l'administration et les chefs d'entité passent", async () => {
    ...
    // Les rôles classiques ne s'attribuent plus ; un compte Direx + chef d'entité, si.
