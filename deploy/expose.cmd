@echo off
rem ARGOS / IRIS - acces public sans toucher au routeur (tunnel sortant).
rem Lance scripts\expose.ps1 en contournant la politique d'execution PowerShell :
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%HERE%scripts\expose.ps1" %*
exit /b %ERRORLEVEL%
