@echo off
rem ARGOS / IRIS - met a jour la station en gardant comptes, donnees et reglages.
rem Lance scripts\upgrade.ps1 en contournant la politique d'execution PowerShell :
