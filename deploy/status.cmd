@echo off
rem ARGOS / IRIS - etat de la station.
rem Lance scripts\status.ps1 en contournant la politique d'execution PowerShell :
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%HERE%scripts\status.ps1" %*
exit /b %ERRORLEVEL%
