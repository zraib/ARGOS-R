@echo off
rem ARGOS / IRIS - sauvegarde.
rem Lance scripts\backup.ps1 en contournant la politique d'execution PowerShell :
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%HERE%scripts\backup.ps1" %*
exit /b %ERRORLEVEL%
